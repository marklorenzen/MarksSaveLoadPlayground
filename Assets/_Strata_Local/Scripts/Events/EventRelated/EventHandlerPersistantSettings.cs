...
namespace Strata.Events
{
    ...
    /// <summary>
    /// Converts a EventPersistantSettingChange event into a unity event.
    /// </summary>
    public class EventHandlerPersistantSettings : MonoBehaviour, IEventListener
    {
        ...
        /// <summary>
        /// Handling either the EventPersistantSettingChange events.
        /// </summary>
